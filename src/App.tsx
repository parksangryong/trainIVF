...
function App({ url }: { url?: string }) {
  ...
  return <><RouterProvider router={router} /><AdSense slot={import.meta.env.VITE_ADSENSE_SLOT} /><a href="/privacy" style={{display:"block",textAlign:"center",margin:"0 0 28px",color:"#7898a9",fontSize:12}}>개인정보처리방침</a></>;
}
